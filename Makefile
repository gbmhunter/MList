...
# @brief 			Makefile for Linux-based make, to compile the MList module, example code and run unit test code.
# @details
...
test : deps $(TEST_OBJ_FILES) | src
	...
	g++ $(TEST_LD_FLAGS) -o ./test/Tests.elf $(TEST_OBJ_FILES) -L./ -lMList $(DEP_LIB_PATHS) $(DEP_LIBS)
